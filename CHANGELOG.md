...
- Add an `@smithy4s.meta#unpackedOutput` trait that can be used to avoid packing an operation's output up in an additional case class in user code in [TBD](TBD)
