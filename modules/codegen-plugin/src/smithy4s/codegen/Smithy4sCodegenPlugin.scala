  ...
  object autoImport {
    ...
    val smithy4sAllowedNamespaces =
      settingKey[List[String]](
        "Allow-list of namespaces that should be processed by the generator. If unset, considers all namespaces but stdlib ones. Deprecated: use the `smithy4sCodegen` Smithy metadata key with `allowedNamespaces` instead."
      )
    ...
    val smithy4sExcludedNamespaces =
      settingKey[List[String]](
        "Disallow-list of namespaces that should not be processed by the generator. When set, namespaces are evicted as the last filtering step. Deprecated: use the `smithy4sCodegen` Smithy metadata key with `excludedNamespaces` instead."
      )
