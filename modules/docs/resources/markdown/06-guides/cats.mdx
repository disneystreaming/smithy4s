...
The recommended way to use them is to let smithy4s place the resulting instances directly in the generated companion objects via the [`smithy4s.meta#typeclass` trait](../04-codegen/01-customisation/09-typeclass) - that page walks through the `cats.Hash` case end-to-end.
