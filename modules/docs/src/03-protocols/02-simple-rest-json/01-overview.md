...
Smithy4s comes with opt-in http4s-specific module, that contain functions that are aware of this protocol, and can be used to quickly synthetise http services and clients.
