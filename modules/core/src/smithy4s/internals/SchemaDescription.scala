...
object SchemaDescription extends SchemaVisitor[SchemaDescription] {
  ...
  override def nullable[A](shapeId: ShapeId,
      hints: Hints, schema: Schema[A]): SchemaDescription[Option[A]] =
    SchemaDescription.of("Nullable")

  override def lazily[A](shapeId: ShapeId, hints: Hints, suspend: Lazy[Schema[A]]): SchemaDescription[A] =
