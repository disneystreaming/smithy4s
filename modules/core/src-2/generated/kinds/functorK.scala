...
object FunctorK {
  ...
  implicit def polyfunctionFunctorK[F[_]]: FunctorK[PolyFunction[F, *[_]]] =
    new FunctorK[PolyFunction[F, *[_]]] {
      def mapK[G[_], H[_]](
          fa: PolyFunction[F, G],
          fk: PolyFunction[G, H]
...
object FunctorK2 {
  ...
  implicit def polyfunctionFunctorK2[F[_, _]]
      : FunctorK2[PolyFunction2[F, *[_, _]]] =
    new FunctorK2[PolyFunction2[F, *[_, _]]] {
...
object FunctorK5 {
  ...
  implicit def polyfunctionFunctorK5[F[_, _, _, _, _]]
      : FunctorK5[PolyFunction5[F, *[_, _, _, _, _]]] =
    new FunctorK5[PolyFunction5[F, *[_, _, _, _, _]]] {
