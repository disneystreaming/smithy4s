...
package object example {
  ...
  type EmptyService[F[_]] = smithy4s.Monadic[EmptyServiceGen, F]
  object EmptyService extends smithy4s.Service.Provider[EmptyServiceGen, EmptyServiceOperation] {
    def apply[F[_]](implicit F: EmptyService[F]): F.type = F
    def service : smithy4s.Service[EmptyServiceGen, EmptyServiceOperation] = EmptyServiceGen
    val id: smithy4s.ShapeId = service.id
  }
