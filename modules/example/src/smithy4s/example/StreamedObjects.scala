...
import smithy4s.example.GetStreamedObjectInput.schema
import smithy4s.example.StreamedBlob.schema
import smithy4s.schema.Schema._
import smithy4s.example.PutStreamedObjectInput.schema
import smithy4s.example.GetStreamedObjectOutput.schema
