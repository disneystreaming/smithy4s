...
object TestAdt extends ShapeTag.Companion[TestAdt] {
  ...
  case class AdtOne(lng: Option[Long] = None, sht: Option[Short] = None, blb: Option[ByteArray] = None, str: Option[String] = None) extends TestAdt with AdtMixinTwo with AdtMixinOne with AdtMixinThree
  ...
  case class AdtTwo(lng: Option[Long] = None, sht: Option[Short] = None, int: Option[Int] = None) extends TestAdt with AdtMixinTwo with AdtMixinOne
