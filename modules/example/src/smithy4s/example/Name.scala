...
object Name extends Newtype[smithy4s.example.refined.Name] {
  ...
  val underlyingSchema : smithy4s.Schema[smithy4s.example.refined.Name] = string.refined[smithy4s.example.refined.Name](smithy4s.example.NameFormat()).withId(id).addHints(hints)
