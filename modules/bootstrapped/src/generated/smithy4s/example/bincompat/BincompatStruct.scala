...
object BincompatStruct extends ShapeTag.Companion[BincompatStruct] {
  ...
  implicit val schema: Schema[BincompatStruct] = struct(
    ...
    string.required[BincompatStruct]("added2_1", _.added2_1).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.fromString("woop2_1"))),
    string.optional[BincompatStruct]("added2_2", _.added2_2),
    string.required[BincompatStruct]("added3_1", _.added3_1).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.fromString("woop3_1"))),
    string.optional[BincompatStruct]("added3_2", _.added3_2),
    string.field[BincompatStruct]("added4_1", _.added4_1).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.fromString("woop4_1"))),
