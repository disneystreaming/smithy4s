...
final class BincompatStruct private(val base1: String, val base2: String, val base4: String, val added2_1: String, val added3_1: String, val added4_1: String, val base3: Option[String], val added2_2: Option[String], val added3_2: Option[String]) extends Serializable {
  ...
  private def copy(base1: String = this.base1, base2: String = this.base2, base4: String = this.base4, added2_1: String = this.added2_1, added3_1: String = this.added3_1, added4_1: String = this.added4_1, base3: Option[String] = this.base3, added2_2: Option[String] = this.added2_2, added3_2: Option[String] = this.added3_2): BincompatStruct = new BincompatStruct(base1, base2, base4, added2_1, added3_1, added4_1, base3, added2_2, added3_2)
  override def equals(another: Any): Boolean = another match {
    case another: BincompatStruct => (this eq another) || this.base1 == another.base1 && this.base2 == another.base2 && this.base4 == another.base4 && this.added2_1 == another.added2_1 && this.added3_1 == another.added3_1 && this.added4_1 == another.added4_1 && this.base3 == another.base3 && this.added2_2 == another.added2_2 && this.added3_2 == another.added3_2
    case _ => false
  }
  override def hashCode(): Int = 37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (37 * (17 + "smithy4s.example.bincompat.BincompatStruct".##) + this.base1.##) + this.base2.##) + this.base4.##) + this.added2_1.##) + this.added3_1.##) + this.added4_1.##) + this.base3.##) + this.added2_2.##) + this.added3_2.##)
  override def toString(): String = "BincompatStruct(" + this.base1 + ", " + this.base2 + ", " + this.base4 + ", " + this.added2_1 + ", " + this.added3_1 + ", " + this.added4_1 + ", " + this.base3 + ", " + this.added2_2 + ", " + this.added3_2 + ")"
}
