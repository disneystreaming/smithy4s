...
object OffsetDateTimeWrapper extends ShapeTag.Companion[OffsetDateTimeWrapper] {
  ...
  implicit val schema: Schema[OffsetDateTimeWrapper] = struct(
    offsetdatetime.optional[OffsetDateTimeWrapper]("string", _.string).addHints(Hints.Binding.DynamicBinding(ShapeId("alloy.proto", "protoOffsetDateTimeFormat"), smithy4s.Document.fromString("RFC3339_STRING"))),
    offsetdatetime.optional[OffsetDateTimeWrapper]("compact", _.compact).addHints(Hints.Binding.DynamicBinding(ShapeId("alloy.proto", "protoOffsetDateTimeFormat"), smithy4s.Document.fromString("PROTOBUF"))),
