...
object DeprecatedStructure extends ShapeTag.Companion[DeprecatedStructure] {
  ...
  val hints: Hints = Hints(
    Hints.Binding.DynamicBinding(ShapeId("smithy.api", "deprecated"), smithy4s.Document.obj("message" -> smithy4s.Document.fromString("A compelling reason"), "since" -> smithy4s.Document.fromString("0.0.1"))),
  ).lazily
  ...
  implicit val schema: Schema[DeprecatedStructure] = struct(
    Strings.underlyingSchema.optional[DeprecatedStructure]("strings", _.strings).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "deprecated"), smithy4s.Document.obj())),
    Strings.underlyingSchema.optional[DeprecatedStructure]("other", _.other),
    string.optional[DeprecatedStructure]("name", _.name).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "deprecated"), smithy4s.Document.obj())),
