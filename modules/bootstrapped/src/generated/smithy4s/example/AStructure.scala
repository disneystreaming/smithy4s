...
object AStructure extends ShapeTag.Companion[AStructure] {
  ...
  implicit val schema: Schema[AStructure] = struct(
    AString.schema.field[AStructure]("astring", _.astring).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.fromString("\"Hello World\" with \"quotes\""))),
