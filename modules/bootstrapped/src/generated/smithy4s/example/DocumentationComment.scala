...
object DocumentationComment extends ShapeTag.Companion[DocumentationComment] {
  ...
  val hints: Hints = Hints(
    Hints.Binding.DynamicBinding(ShapeId("smithy.api", "documentation"), smithy4s.Document.fromString("We should be able to use comments in documentation /* */")),
  ).lazily
  ...
  implicit val schema: Schema[DocumentationComment] = struct(
    string.optional[DocumentationComment]("member", _.member).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "documentation"), smithy4s.Document.fromString("/*"))),
