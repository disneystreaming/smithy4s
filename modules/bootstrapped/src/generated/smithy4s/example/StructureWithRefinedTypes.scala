...
object StructureWithRefinedTypes extends ShapeTag.Companion[StructureWithRefinedTypes] {
  ...
  val hints: Hints = Hints(
    Hints.Binding.DynamicBinding(ShapeId("smithy4s.example", "uuidTrait"), smithy4s.Document.fromString("00000000-0000-0000-0000-000000000000")),
  ).lazily
  ...
  implicit val schema: Schema[StructureWithRefinedTypes] = struct(
    ...
    PersonAge.schema.field[StructureWithRefinedTypes]("personAge", _.personAge).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.fromDouble(1.0d))),
    ...
    int.refined[smithy4s.refined.Age](smithy4s.example.AgeFormat()).field[StructureWithRefinedTypes]("inlineFieldConstraint", _.inlineFieldConstraint).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.fromDouble(1.0d)), Hints.Binding.DynamicBinding(ShapeId("smithy4s.example", "ageFormat"), smithy4s.Document.obj())),
    uuid.field[StructureWithRefinedTypes]("uuidField", _.uuidField).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.fromString("00000000-0000-0000-0000-000000000000"))),
    uuid.optional[StructureWithRefinedTypes]("uuidField2", _.uuidField2).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.nullDoc)),
