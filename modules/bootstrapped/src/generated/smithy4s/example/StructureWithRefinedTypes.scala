...
object StructureWithRefinedTypes extends ShapeTag.Companion[StructureWithRefinedTypes] {
  ...
  implicit val schema: Schema[StructureWithRefinedTypes] = struct[StructureWithRefinedTypes](
    ...
    PersonAge.schema.field[StructureWithRefinedTypes]("personAge", _.personAge).addHints(Hints.dynamic(ShapeId("smithy.api", "default"), smithy4s.Document.fromLong(1L))),
    ...
    int.refined[smithy4s.refined.Age](smithy4s.example.AgeFormat()).field[StructureWithRefinedTypes]("inlineFieldConstraint", _.inlineFieldConstraint).addHints(Hints.dynamic(ShapeId("smithy.api", "default"), smithy4s.Document.fromLong(1L))),
