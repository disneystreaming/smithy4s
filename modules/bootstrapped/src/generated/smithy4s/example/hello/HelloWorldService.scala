...
object HelloWorldServiceGen extends Service.Mixin[HelloWorldServiceGen, HelloWorldServiceOperation] {
  ...
  val hints: Hints = Hints(
    ...
    Hints.Binding.DynamicBinding(ShapeId("smithy.api", "tags"), smithy4s.Document.array(smithy4s.Document.fromString("testServiceTag"))),
  ).lazily
