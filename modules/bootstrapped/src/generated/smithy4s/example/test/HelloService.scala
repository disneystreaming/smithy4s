...
object HelloServiceOperation {
  ...
  object Listen extends smithy4s.Endpoint[HelloServiceOperation,Unit, Nothing, Unit, Nothing, Nothing] {
    val schema: OperationSchema[Unit, Nothing, Unit, Nothing, Nothing] = Schema.operation(ShapeId("smithy4s.example.test", "Listen"))
      .withInput(unit)
      .withOutput(unit)
      .withHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "http"), smithy4s.Document.obj("method" -> smithy4s.Document.fromString("GET"), "uri" -> smithy4s.Document.fromString("/listen"))), Hints.Binding.DynamicBinding(ShapeId("smithy.api", "readonly"), smithy4s.Document.obj()), Hints.Binding.DynamicBinding(ShapeId("smithy.test", "httpRequestTests"), smithy4s.Document.array(smithy4s.Document.obj("id" -> smithy4s.Document.fromString("listen"), "protocol" -> smithy4s.Document.fromString("alloy#simpleRestJson"), "method" -> smithy4s.Document.fromString("GET"), "uri" -> smithy4s.Document.fromString("/listen")))))
  ...
  object TestPath extends smithy4s.Endpoint[HelloServiceOperation,TestPathInput, Nothing, Unit, Nothing, Nothing] {
    val schema: OperationSchema[TestPathInput, Nothing, Unit, Nothing, Nothing] = Schema.operation(ShapeId("smithy4s.example.test", "TestPath"))
      ...
      .withOutput(unit)
      .withHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "http"), smithy4s.Document.obj("method" -> smithy4s.Document.fromString("GET"), "uri" -> smithy4s.Document.fromString("/test-path/{path}"))), Hints.Binding.DynamicBinding(ShapeId("smithy.api", "readonly"), smithy4s.Document.obj()), Hints.Binding.DynamicBinding(ShapeId("smithy.test", "httpRequestTests"), smithy4s.Document.array(smithy4s.Document.obj("id" -> smithy4s.Document.fromString("TestPath"), "protocol" -> smithy4s.Document.fromString("alloy#simpleRestJson"), "method" -> smithy4s.Document.fromString("GET"), "uri" -> smithy4s.Document.fromString("/test-path/sameValue"), "params" -> smithy4s.Document.obj("path" -> smithy4s.Document.fromString("sameValue"))))))
  ...
  object SayHello extends smithy4s.Endpoint[HelloServiceOperation,SayHelloInput, HelloServiceOperation.SayHelloError, SayHelloOutput, Nothing, Nothing] {
    val schema: OperationSchema[SayHelloInput, HelloServiceOperation.SayHelloError, SayHelloOutput, Nothing, Nothing] = Schema.operation(ShapeId("smithy4s.example.test", "SayHello"))
      ...
      .withHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "http"), smithy4s.Document.obj("method" -> smithy4s.Document.fromString("POST"), "uri" -> smithy4s.Document.fromString("/"))), Hints.Binding.DynamicBinding(ShapeId("smithy.test", "httpRequestTests"), smithy4s.Document.array(smithy4s.Document.obj("id" -> smithy4s.Document.fromString("say_hello"), "protocol" -> smithy4s.Document.fromString("alloy#simpleRestJson"), "params" -> smithy4s.Document.obj("greeting" -> smithy4s.Document.fromString("Hi"), "name" -> smithy4s.Document.fromString("Teddy"), "query" -> smithy4s.Document.fromString("Hello there")), "method" -> smithy4s.Document.fromString("POST"), "uri" -> smithy4s.Document.fromString("/"), "queryParams" -> smithy4s.Document.array(smithy4s.Document.fromString("Hi=Hello%20there")), "headers" -> smithy4s.Document.obj("X-Greeting" -> smithy4s.Document.fromString("Hi")), "body" -> smithy4s.Document.fromString("{\"name\":\"Teddy\"}"), "bodyMediaType" -> smithy4s.Document.fromString("application/json")))), Hints.Binding.DynamicBinding(ShapeId("smithy.test", "httpResponseTests"), smithy4s.Document.array(smithy4s.Document.obj("id" -> smithy4s.Document.fromString("say_hello"), "protocol" -> smithy4s.Document.fromString("alloy#simpleRestJson"), "params" -> smithy4s.Document.obj("payload" -> smithy4s.Document.obj("result" -> smithy4s.Document.fromString("Hello!")), "header1" -> smithy4s.Document.fromString("V1")), "body" -> smithy4s.Document.fromString("{\"result\":\"Hello!\"}"), "headers" -> smithy4s.Document.obj("X-H1" -> smithy4s.Document.fromString("V1")), "code" -> smithy4s.Document.fromDouble(200.0d)))))
