...
object SayHelloInput extends ShapeTag.Companion[SayHelloInput] {
  ...
  implicit val schema: Schema[SayHelloInput] = struct(
    string.optional[SayHelloInput]("greeting", _.greeting).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "httpHeader"), smithy4s.Document.fromString("X-Greeting"))),
    string.optional[SayHelloInput]("query", _.query).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "httpQuery"), smithy4s.Document.fromString("Hi"))),
