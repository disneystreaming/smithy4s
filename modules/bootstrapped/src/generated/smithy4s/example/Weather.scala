...
object WeatherGen extends Service.Mixin[WeatherGen, WeatherOperation] {
  ...
  val hints: Hints = Hints(
    Hints.Binding.DynamicBinding(ShapeId("smithy.api", "documentation"), smithy4s.Document.fromString("Provides weather forecasts.")),
    Hints.Binding.DynamicBinding(ShapeId("smithy.api", "paginated"), smithy4s.Document.obj("inputToken" -> smithy4s.Document.fromString("nextToken"), "outputToken" -> smithy4s.Document.fromString("nextToken"), "pageSize" -> smithy4s.Document.fromString("pageSize"))),
  ).lazily
...
object WeatherOperation {
  ...
  object GetCurrentTime extends smithy4s.Endpoint[WeatherOperation,Unit, Nothing, GetCurrentTimeOutput, Nothing, Nothing] {
    val schema: OperationSchema[Unit, Nothing, GetCurrentTimeOutput, Nothing, Nothing] = Schema.operation(ShapeId("smithy4s.example", "GetCurrentTime"))
      ...
      .withHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "readonly"), smithy4s.Document.obj()))
  ...
  object ListCities extends smithy4s.Endpoint[WeatherOperation,ListCitiesInput, Nothing, ListCitiesOutput, Nothing, Nothing] {
    val schema: OperationSchema[ListCitiesInput, Nothing, ListCitiesOutput, Nothing, Nothing] = Schema.operation(ShapeId("smithy4s.example", "ListCities"))
      ...
      .withHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "paginated"), smithy4s.Document.obj("items" -> smithy4s.Document.fromString("items"))), Hints.Binding.DynamicBinding(ShapeId("smithy.api", "readonly"), smithy4s.Document.obj()))
