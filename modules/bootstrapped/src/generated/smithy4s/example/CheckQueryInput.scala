...
object CheckQueryInput extends ShapeTag.Companion[CheckQueryInput] {
  ...
  implicit val schema: Schema[CheckQueryInput] = struct(
    QParams.underlyingSchema.optional[CheckQueryInput]("inp", _.inp).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.nullDoc), Hints.Binding.DynamicBinding(ShapeId("smithy.api", "httpQueryParams"), smithy4s.Document.obj())),
