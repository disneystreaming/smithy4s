...
object AddMenuItemRequest extends ShapeTag.Companion[AddMenuItemRequest] {
  ...
  implicit val schema: Schema[AddMenuItemRequest] = struct(
    string.required[AddMenuItemRequest]("restaurant", _.restaurant).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "httpLabel"), smithy4s.Document.obj())),
    MenuItem.schema.required[AddMenuItemRequest]("menuItem", _.menuItem).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "httpPayload"), smithy4s.Document.obj())),
