...
object ListWithMemberHints extends Newtype[List[String]] {
  ...
  val underlyingSchema: Schema[List[String]] = list(string.addMemberHints(Hints.dynamic(ShapeId("smithy.api", "documentation"), smithy4s.Document.fromString("listFoo")))).withId(id).addHints(hints)
