...
object TimestampOperationInput extends ShapeTag.Companion[TimestampOperationInput] {
  ...
  implicit val schema: Schema[TimestampOperationInput] = struct[TimestampOperationInput](
    ...
    timestamp.required[TimestampOperationInput]("epochSeconds", _.epochSeconds).addHints(Hints.dynamic(ShapeId("smithy.api", "default"), smithy4s.Document.fromLong(1716459630L)), Hints.dynamic(ShapeId("smithy.api", "timestampFormat"), smithy4s.Document.fromString("epoch-seconds"))),
