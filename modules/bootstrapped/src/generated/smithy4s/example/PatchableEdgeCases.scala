...
object PatchableEdgeCases extends ShapeTag.Companion[PatchableEdgeCases] {
  ...
  implicit val schema: Schema[PatchableEdgeCases] = struct[PatchableEdgeCases](
    ...
    int.nullable.required[PatchableEdgeCases]("requiredDefaultValue", _.requiredDefaultValue).addHints(Hints.dynamic(ShapeId("smithy.api", "default"), smithy4s.Document.fromLong(3L))),
    ...
    int.nullable.field[PatchableEdgeCases]("defaultValue", _.defaultValue).addHints(Hints.dynamic(ShapeId("smithy.api", "default"), smithy4s.Document.fromLong(5L))),
