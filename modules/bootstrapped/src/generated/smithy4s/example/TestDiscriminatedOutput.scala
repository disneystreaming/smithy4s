...
object TestDiscriminatedOutput extends ShapeTag.Companion[TestDiscriminatedOutput] {
  ...
  implicit val schema: Schema[TestDiscriminatedOutput] = struct(
    PayloadData.schema.optional[TestDiscriminatedOutput]("data", _.data).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "httpPayload"), smithy4s.Document.obj())),
