...
object JsonUnknownExample extends ShapeTag.Companion[JsonUnknownExample] {
  ...
  implicit val schema: Schema[JsonUnknownExample] = struct(
    ...
    AdditionalProperties.underlyingSchema.optional[JsonUnknownExample]("additionalProperties", _.additionalProperties).addHints(Hints.Binding.DynamicBinding(ShapeId("alloy", "jsonUnknown"), smithy4s.Document.obj())),
