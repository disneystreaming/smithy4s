...
object ObjectServiceOperation {
  ...
  sealed trait PutObjectError extends _root_.scala.Product with _root_.scala.Serializable { self =>
  ...
  sealed trait GetObjectError extends _root_.scala.Product with _root_.scala.Serializable { self =>
