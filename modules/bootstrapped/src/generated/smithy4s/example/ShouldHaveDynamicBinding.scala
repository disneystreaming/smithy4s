...
object ShouldHaveDynamicBinding extends ShapeTag.Companion[ShouldHaveDynamicBinding] {
  ...
  implicit val schema: Schema[ShouldHaveDynamicBinding] = struct[ShouldHaveDynamicBinding](
    string.optional[ShouldHaveDynamicBinding]("a", _.a).addHints(Hints.dynamic(ShapeId("smithy.api", "since"), smithy4s.Document.fromString("2")), Hints.dynamic(ShapeId("smithy4s.example", "testDynamicBinding"), smithy4s.Document.obj("str" -> smithy4s.Document.fromString("test2"), "int" -> smithy4s.Document.fromLong(1234L)))),
