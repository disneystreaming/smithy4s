...
object HeadersWithDefaults extends ShapeTag.Companion[HeadersWithDefaults] {
  ...
  implicit val schema: Schema[HeadersWithDefaults] = struct(
    string.field[HeadersWithDefaults]("dflt", _.dflt).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.fromString("test")), Hints.Binding.DynamicBinding(ShapeId("smithy.api", "httpHeader"), smithy4s.Document.fromString("dflt"))),
