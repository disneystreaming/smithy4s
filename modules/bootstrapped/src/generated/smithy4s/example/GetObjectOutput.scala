...
object GetObjectOutput extends ShapeTag.Companion[GetObjectOutput] {
  ...
  implicit val schema: Schema[GetObjectOutput] = struct(
    ObjectSize.schema.required[GetObjectOutput]("size", _.size).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "httpHeader"), smithy4s.Document.fromString("X-Size"))),
    string.optional[GetObjectOutput]("data", _.data).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "httpPayload"), smithy4s.Document.obj())),
