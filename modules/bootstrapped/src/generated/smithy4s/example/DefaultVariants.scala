...
object DefaultVariants extends ShapeTag.Companion[DefaultVariants] {
  ...
  implicit val schema: Schema[DefaultVariants] = struct(
    ...
    string.required[DefaultVariants]("reqDef", _.reqDef).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.fromString("default"))),
    string.optional[DefaultVariants]("opt", _.opt),
    string.field[DefaultVariants]("optDef", _.optDef).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.fromString("default"))),
