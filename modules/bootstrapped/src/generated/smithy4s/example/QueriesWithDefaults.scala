...
object QueriesWithDefaults extends ShapeTag.Companion[QueriesWithDefaults] {
  ...
  implicit val schema: Schema[QueriesWithDefaults] = struct(
    string.field[QueriesWithDefaults]("dflt", _.dflt).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "default"), smithy4s.Document.fromString("test")), Hints.Binding.DynamicBinding(ShapeId("smithy.api", "httpQuery"), smithy4s.Document.fromString("dflt"))),
