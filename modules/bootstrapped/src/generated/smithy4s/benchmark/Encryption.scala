...
object Encryption extends ShapeTag.Companion[Encryption] {
  ...
  implicit val schema: Schema[Encryption] = struct(
    ...
    timestamp.optional[Encryption]("date", _.date).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "timestampFormat"), smithy4s.Document.fromString("epoch-seconds"))),
