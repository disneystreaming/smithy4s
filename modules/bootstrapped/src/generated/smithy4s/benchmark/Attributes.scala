...
object Attributes extends ShapeTag.Companion[Attributes] {
  ...
  implicit val schema: Schema[Attributes] = struct(
    ...
    timestamp.required[Attributes]("creationDate", _.creationDate).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "timestampFormat"), smithy4s.Document.fromString("epoch-seconds"))),
    string.required[Attributes]("region", _.region),
    boolean.optional[Attributes]("queryable", _.queryable),
    timestamp.optional[Attributes]("queryableLastChange", _.queryableLastChange).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "timestampFormat"), smithy4s.Document.fromString("epoch-seconds"))),
