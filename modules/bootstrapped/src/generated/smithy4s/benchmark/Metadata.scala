...
object Metadata extends ShapeTag.Companion[Metadata] {
  ...
  implicit val schema: Schema[Metadata] = struct(
    ...
    timestamp.optional[Metadata]("lastModified", _.lastModified).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "timestampFormat"), smithy4s.Document.fromString("epoch-seconds"))),
