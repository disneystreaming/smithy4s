...
object InternalServerError extends ShapeTag.Companion[InternalServerError] {
  ...
  val hints: Hints = Hints(
    Hints.Binding.DynamicBinding(ShapeId("smithy.api", "documentation"), smithy4s.Document.fromString("<p>An error occurred on the server side.</p>")),
  ...
  implicit val schema: Schema[InternalServerError] = struct(
    ErrorMessage.schema.optional[InternalServerError]("message", _.message).addHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "documentation"), smithy4s.Document.fromString("<p>The server encountered an internal error trying to fulfill the request.</p>"))),
