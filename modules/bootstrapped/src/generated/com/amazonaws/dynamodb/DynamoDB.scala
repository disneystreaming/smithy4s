...
object DynamoDBGen extends Service.Mixin[DynamoDBGen, DynamoDBOperation] {
  ...
  val hints: Hints = Hints(
    Hints.Binding.DynamicBinding(ShapeId("aws.api", "clientEndpointDiscovery"), smithy4s.Document.obj("operation" -> smithy4s.Document.fromString("com.amazonaws.dynamodb#DescribeEndpoints"), "error" -> smithy4s.Document.fromString("com.amazonaws.dynamodb#InvalidEndpointException"))),
    Hints.Binding.DynamicBinding(ShapeId("aws.api", "service"), smithy4s.Document.obj("sdkId" -> smithy4s.Document.fromString("DynamoDB"), "arnNamespace" -> smithy4s.Document.fromString("dynamodb"), "cloudFormationName" -> smithy4s.Document.fromString("DynamoDB"), "cloudTrailEventSource" -> smithy4s.Document.fromString("dynamodb.amazonaws.com"), "endpointPrefix" -> smithy4s.Document.fromString("dynamodb"))),
    Hints.Binding.DynamicBinding(ShapeId("aws.auth", "sigv4"), smithy4s.Document.obj("name" -> smithy4s.Document.fromString("dynamodb"))),
    Hints.Binding.DynamicBinding(ShapeId("aws.protocols", "awsJson1_0"), smithy4s.Document.obj()),
    Hints.Binding.DynamicBinding(ShapeId("smithy.api", "documentation"), smithy4s.Document.fromString("<fullname>Amazon DynamoDB</fullname>\n\n\n         <p>Amazon DynamoDB is a fully managed NoSQL database service that provides fast and\n      predictable performance with seamless scalability. DynamoDB lets you offload the\n      administrative burdens of operating and scaling a distributed database, so that you don\'t have\n      to worry about hardware provisioning, setup and configuration, replication, software patching,\n      or cluster scaling.</p>\n\n         <p>With DynamoDB, you can create database tables that can store and retrieve any amount of\n      data, and serve any level of request traffic. You can scale up or scale down your tables\'\n      throughput capacity without downtime or performance degradation, and use the AWS Management\n      Console to monitor resource utilization and performance metrics.</p>\n\n         <p>DynamoDB automatically spreads the data and traffic for your tables over a sufficient\n      number of servers to handle your throughput and storage requirements, while maintaining\n      consistent and fast performance. All of your data is stored on solid state disks (SSDs) and\n      automatically replicated across multiple Availability Zones in an AWS region, providing\n      built-in high availability and data durability. </p>")),
    Hints.Binding.DynamicBinding(ShapeId("smithy.api", "title"), smithy4s.Document.fromString("Amazon DynamoDB")),
    Hints.Binding.DynamicBinding(ShapeId("smithy.api", "xmlNamespace"), smithy4s.Document.obj("uri" -> smithy4s.Document.fromString("http://dynamodb.amazonaws.com/doc/2012-08-10/"))),
  ).lazily
...
object DynamoDBOperation {
  ...
  object ListTables extends smithy4s.Endpoint[DynamoDBOperation,ListTablesInput, DynamoDBOperation.ListTablesError, ListTablesOutput, Nothing, Nothing] {
    val schema: OperationSchema[ListTablesInput, DynamoDBOperation.ListTablesError, ListTablesOutput, Nothing, Nothing] = Schema.operation(ShapeId("com.amazonaws.dynamodb", "ListTables"))
      ...
      .withHints(Hints.Binding.DynamicBinding(ShapeId("aws.api", "clientDiscoveredEndpoint"), smithy4s.Document.obj("required" -> smithy4s.Document.fromBoolean(false))), Hints.Binding.DynamicBinding(ShapeId("smithy.api", "documentation"), smithy4s.Document.fromString("<p>Returns an array of table names associated with the current account and endpoint. The output\n      from <code>ListTables</code> is paginated, with each page returning a maximum of 100 table\n      names.</p>")), Hints.Binding.DynamicBinding(ShapeId("smithy.api", "paginated"), smithy4s.Document.obj("inputToken" -> smithy4s.Document.fromString("ExclusiveStartTableName"), "outputToken" -> smithy4s.Document.fromString("LastEvaluatedTableName"), "items" -> smithy4s.Document.fromString("TableNames"), "pageSize" -> smithy4s.Document.fromString("Limit"))))
  ...
  object DescribeEndpoints extends smithy4s.Endpoint[DynamoDBOperation,DescribeEndpointsRequest, Nothing, DescribeEndpointsResponse, Nothing, Nothing] {
    val schema: OperationSchema[DescribeEndpointsRequest, Nothing, DescribeEndpointsResponse, Nothing, Nothing] = Schema.operation(ShapeId("com.amazonaws.dynamodb", "DescribeEndpoints"))
      ...
      .withHints(Hints.Binding.DynamicBinding(ShapeId("smithy.api", "documentation"), smithy4s.Document.fromString("<p>Returns the regional endpoint information.</p>")))
